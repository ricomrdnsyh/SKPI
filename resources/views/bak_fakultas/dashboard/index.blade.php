            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card border-0 mb-8 rounded-4 overflow-hidden shadow-sm"
                    ...
                    <div class="position-absolute bottom-0 start-0 opacity-10">
                        <i class="ki-duotone ki-bank text-white" style="font-size: 10rem; transform: translate(-30%, 30%);">
                            ...
                            <div
                                ...
                                <div class="symbol symbol-60px symbol-md-70px symbol-circle shadow-sm">
                                    <div
                                        ...
                                        <i class="ki-duotone ki-bank fs-2x fs-md-3x text-white"><span
                                                class="path1"></span><span class="path2"></span></i>
                                    </div>
                                </div>

                                <div class="d-flex flex-column">
                                    <h2 class="text-white fw-bolder fs-2 fs-md-1 mb-2">Dashboard BAAK Fakultas</h2>
                    ...
                    <div class="card-body py-4 px-8 filter-container mt-4">
                        <div class="border border-dashed rounded p-5 mb-5" style="border-color: #b5b5c3 !important;">
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12" id="status-filter-wrapper">
