                ...
                <div class="modal-body">
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        <div class="fv-row">
                            ...
                            <input type="text" name="tempat_magang" id="tempat_magang" required class="form-control form-control-solid" placeholder="Contoh: PT. Sumber Jaya Makmur">
                        </div>

                        <div class="fv-row">
                            <label for="posisi" class="form-label required fw-bold fs-6">Posisi / Jabatan Intern</label>
                            <input type="text" name="posisi" id="posisi" required class="form-control form-control-solid" placeholder="Contoh: Junior Web Developer">
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        <div class="fv-row">
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ date('Y-m-d') }}" required class="form-control form-control-solid">
                        </div>

                        <div class="fv-row">
                            <label for="tanggal_selesai" class="form-label required fw-bold fs-6">Tanggal Selesai</label>
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ date('Y-m-d') }}" required class="form-control form-control-solid">
                        </div>
                    </div>
