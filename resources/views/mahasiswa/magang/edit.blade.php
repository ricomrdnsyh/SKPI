            ...
            <form id="form_edit_magang" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row mb-5">
                        <label for="nim_edit" class="form-label required fw-bold fs-6">Pilih Mahasiswa</label>
                        <select name="nim" id="nim_edit" required class="form-select" data-control="select2" data-placeholder="Pilih Mahasiswa" data-dropdown-parent="#form_edit">
                            <option value=""></option>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                <input type="text" name="tanggal_selesai" id="edit_tanggal_selesai" required class="form-control" placeholder="Pilih tanggal selesai">
                            </div>
                        </div>
                    </div>
                    <div class="fv-row mb-5">
                        ...
                        <div class="mt-1">
                            <label class="d-flex flex-column align-items-center justify-content-center p-5 border border-2 border-dashed border-warning rounded-3 cursor-pointer" style="background-color: #fff8f1;">
                                ...
                                <input type="file" name="file_bukti" id="edit_file_bukti" class="d-none" onchange="document.getElementById('file_name_display_edit_magang').textContent = this.files[0] ? this.files[0].name : ''; document.getElementById('file_name_display_edit_magang').style.display = this.files[0] ? 'inline-block' : 'none';">
                                <div id="file_name_display_edit_magang" class="mt-4 badge badge-light-success fs-6 py-2 px-4" style="display: none;"></div>
                            </label>
                        </div>
                    </div>
                </div>
