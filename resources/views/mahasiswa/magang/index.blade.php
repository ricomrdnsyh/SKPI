                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h3 class="card-title align-items-start flex-column"><span class="card-label fw-bolder fs-3 mb-1">List Manajemen Magang</span></h3>
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#form_create"><i class="fas fa-plus"></i> Tambah Manajemen Magang</button>
                            </div>
                        </div>
                    </div>
                    <div class="separator my-5"></div>
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table-magang">
                            <thead class="">
...
@include('mahasiswa.magang.create')
@include('mahasiswa.magang.edit')
@endsection
@section('js')
    ...
    @include('mahasiswa.magang.script.index')
    
@include('mahasiswa.magang.script.create')
@include('mahasiswa.magang.script.edit')
@endsection
