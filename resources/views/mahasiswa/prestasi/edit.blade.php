            ...
            <form id="form_edit_prestasi" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="fv-row mb-5">
                        ...
                        <input type="text" name="nama_prestasi" id="edit_nama_prestasi" required class="form-control form-control-solid" placeholder="Contoh: Juara 1 Web Design Nasional">
                    </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        ...
                        <div class="fv-row">
                            ...
                            <input type="text" name="peringkat" id="edit_peringkat" required class="form-control form-control-solid" placeholder="Contoh: Juara 1 / Best Paper">
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        <div class="fv-row">
                            ...
                            <input type="text" name="penyelenggara" id="edit_penyelenggara" required class="form-control form-control-solid" placeholder="Contoh: Puspresnas Kemendikbud">
                        </div>

                        <div class="fv-row">
                            <label for="edit_tahun" class="form-label required fw-bold fs-6">Tahun Perolehan</label>
                            <input type="number" name="tahun" id="edit_tahun" required class="form-control form-control-solid" placeholder="Contoh: 2026">
                        </div>
                    </div>
