...
@section('content')
                            ...
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    <h3 class="card-title align-items-start flex-column"><span
                                            class="card-label fw-bolder fs-3 mb-1">List Prestasi</span></h3>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#form_create"><i class="fas fa-plus"></i> Tambah Prestasi</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table-prestasi">
                                <thead class="">
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-150px">Nama Prestasi</th>
    ...
    @include('mahasiswa.prestasi.show')
@endsection
@section('js')
    ...
    @include('mahasiswa.prestasi.script.show')
@endsection
