<script>
    function editModal(element) {
        ...
        let form = document.getElementById('form_edit_prestasi');
        ...
        // Set form action
        form.action = '/mahasiswa/prestasi/' + data.id_prestasi;

        $('#form_edit').modal('show');
    }

    document.addEventListener('DOMContentLoaded', function() {
        const formEdit = document.getElementById('form_edit_prestasi');
        if (!formEdit) return;
