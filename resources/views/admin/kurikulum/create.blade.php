        ...
        <div class="modal-content">
            ...
            <form id="form_create_kurikulum" action="{{ route('kurikulum.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row mb-5">
                        <label for="tahun" class="form-label required fw-bolder text-dark fs-6">Tahun Kurikulum</label>
                        <input type="number" name="tahun" id="tahun" required class="form-control form-control-sm" placeholder="Contoh: 2024" min="2000" max="2099">
                    </div>
                </div>
