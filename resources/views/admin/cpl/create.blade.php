<div class="modal fade" id="form_create" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form id="form_create_cpl" action="{{ route('cpl.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        ...
                        <div class="fv-row">
                            <label for="id_kategori" class="form-label required fw-bolder text-dark">Kategori CPL</label>
                            <select name="id_kategori" id="id_kategori" required class="form-select form-select-sm" data-control="select2" data-dropdown-parent="#form_create" data-placeholder="Pilih Kategori">
                        ...
                        <div class="fv-row">
                            <label for="kode_cpl" class="form-label required fw-bolder text-dark">Kode CPL</label>
                            <input type="text" name="kode_cpl" id="kode_cpl" required class="form-control form-control-sm" placeholder="Contoh: CPL-S01">
                        </div>
                        <div class="fv-row">
                            <label for="urutan" class="form-label fw-bolder text-dark">Urutan Tampil</label>
