            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card border-0 mb-8 rounded-4 overflow-hidden shadow-sm">
                    ...
                    <div class="position-absolute top-0 end-0 h-100 w-100"
                        style="background: radial-gradient(circle at 100% 100%, rgba(0, 163, 255, 0.1) 0%, transparent 50%), radial-gradient(circle at 0% 0%, rgba(0, 163, 255, 0.05) 0%, transparent 50%); pointer-events: none;">
                    </div>
                            ...
                            <div
                                ...
                                <div class="symbol symbol-60px symbol-md-70px symbol-circle shadow-sm">
                                    <div class="symbol-label bg-light-primary border border-primary border-dashed">
                                        <i class="ki-duotone ki-shield-tick fs-2x fs-md-3x text-primary"><span
                                ...
                                <div
                                    ...
                                    <div class="symbol symbol-40px symbol-circle">
                                        <div class="symbol-label bg-light-primary">
                                            <i class="ki-duotone ki-calendar fs-3 text-primary"><span
                                                    class="path1"></span><span class="path2"></span></i>
                                        </div>
                                    </div>
