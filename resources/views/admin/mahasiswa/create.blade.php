            ...
            <form id="form_create_mahasiswa" action="{{ route('mahasiswa.store') }}" method="POST"
                ...
                <div class="modal-body">
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        ...
                        <div class="fv-row">
                            <label for="nama_lengkap" class="form-label required fw-bolder text-dark">Nama
                                Lengkap</label>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                        <div class="fv-row">
                            ...
                            <select name="id_prodi" id="id_prodi" required class="form-select form-select-sm"
                        ...
                        <div class="fv-row">
                            ...
                            <select name="id_kurikulum" id="id_kurikulum" required class="form-select form-select-sm"
                                data-control="select2" data-dropdown-parent="#form_create"
                        ...
                        <div class="fv-row">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <input class="form-control form-control-sm ps-12" placeholder="Pilih tanggal"
                                    id="tanggal_lahir" name="tanggal_lahir" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-6">
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <div class="text-muted mt-2">Kosongkan jika tidak ingin mengubah password atau membiarkannya
                            default (untuk create password default adalah NIM jika dikosongkan)</div>
                    </div>
                </div>
