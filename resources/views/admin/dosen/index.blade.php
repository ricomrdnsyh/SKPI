                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h3 class="card-title align-items-start flex-column"><span class="card-label fw-bolder fs-3 mb-1">List Dosen</span></h3>
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end gap-2" data-kt-customer-table-toolbar="base">
                                @if(Auth::user()->role === 'admin')
                                    <button type="button" class="btn btn-sm btn-primary" id="btn_sync_dosen"><i class="fas fa-sync"></i> Sinkronisasi Data Dosen</button>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row g-5">
                                    @if(auth()->user()->role == 'admin')
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <select class="form-select form-select-sm" data-control="select2" data-placeholder="Semua Fakultas" data-allow-clear="true" data-filter="fakultas" id="filter-fakultas">
                                    ...
                                    @endif
                                    <div class="col-lg-{{ auth()->user()->role == 'admin' ? '6' : '12' }} col-md-{{ auth()->user()->role == 'admin' ? '6' : '12' }} col-sm-12">
                                        <label class="form-label fw-bold mb-2">Program Studi:</label>
                                        <select class="form-select form-select-sm" data-control="select2" data-placeholder="Semua Prodi" data-allow-clear="true" data-filter="prodi" id="filter-prodi">
...
@section('js')
    ...
    @include('admin.dosen.script.index')
    @include('admin.dosen.script.edit')
    @include('admin.dosen.script.show')
@endsection
