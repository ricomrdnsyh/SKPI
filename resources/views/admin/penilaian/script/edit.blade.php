<script>
    function editModal(element) {
        ...
        let form = document.getElementById('form_edit_penilaian');
        ...
        // Set form action
        form.action = '/admin/penilaian/' + data.id_penilaian;
        $('#form_edit').modal('show');
    }
    document.addEventListener('DOMContentLoaded', function() {
        const formEdit = document.getElementById('form_edit_penilaian');
        if (!formEdit) return;
