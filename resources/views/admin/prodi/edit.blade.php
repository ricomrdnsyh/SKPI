            ...
            <form id="form_edit_prodi" action="" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-5">
                        ...
                        <div class="fv-row">
                            <label for="edit_kode_prodi" class="form-label fw-bolder text-dark fs-6">Singkatan</label>
                            <input type="text" name="kode_prodi" id="edit_kode_prodi"
                                class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-5">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-5">
                        <div class="fv-row">
                            <label for="edit_jenjang_kkni" class="form-label fw-bolder text-dark fs-6">Jenjang
                                KKNI</label>
                            <input type="text" name="jenjang_kkni" id="edit_jenjang_kkni"
                                class="form-control form-control-sm">
                        </div>
                        <div class="fv-row">
                            <label for="edit_bahasa_pengantar" class="form-label fw-bolder text-dark fs-6">Bahasa
                                Pengantar</label>
                            <input type="text" name="bahasa_pengantar" id="edit_bahasa_pengantar"
                                class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-md-2 g-6 mb-5">
                        <div class="fv-row">
                            ...
                            <input type="text" name="lama_studi" id="edit_lama_studi"
                                class="form-control form-control-sm">
                        </div>
                        <div class="fv-row">
                            <label for="edit_jenis_pendidikan" class="form-label fw-bolder text-dark fs-6">Jenis
                                Pendidikan</label>
                            <select name="jenis_pendidikan" id="edit_jenis_pendidikan"
                    ...
                    <div class="fv-row mb-5">
                        <label for="edit_jenis_pendidikan_lanjutan"
                            class="form-label fw-bolder text-dark fs-6">Pendidikan Lanjutan</label>
                        <input type="text" name="jenis_pendidikan_lanjutan" id="edit_jenis_pendidikan_lanjutan"
                            class="form-control form-control-sm">
                    </div>

                    <div class="fv-row mb-5">
                        <label for="edit_persyaratan_penerimaan"
                            class="form-label fw-bolder text-dark fs-6">Persyaratan Penerimaan</label>
                        <textarea name="persyaratan_penerimaan" id="edit_persyaratan_penerimaan" rows="2"
