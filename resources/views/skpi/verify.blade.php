    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <div class="w-lg-600px bg-body rounded border border-dashed border-dark shadow-sm p-10 p-lg-15 mx-auto">
                    <div class="text-center mb-10">
                        <i class="ki-duotone ki-shield-tick fs-5x text-success mb-5"><span class="path1"></span><span
                                class="path2"></span></i>
                        <h1 class="text-dark mb-3">Dokumen SKPI Valid!</h1>
                        <div class="text-gray-500 fs-5">Surat Keterangan Pendamping Ijazah (SKPI) ini terdaftar resmi di
                            basis data Universitas Nurul Jadid.</div>
                    </div>

                    <div class="border border-dashed border-gray-500 rounded px-7 py-5 mb-10">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-7 fw-bolder text-dark">{{ $mahasiswa->programStudi->nama_prodi ?? '-' }}
                            </div>
                        </div>

                        <div class="row mb-5">
                            <div class="col-sm-5 fw-semibold text-muted">Fakultas</div>
                            <div class="col-sm-7 fw-bolder text-dark">{{ $fakultas->nama_fakultas ?? '-' }}</div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 fw-bolder text-dark">{{ $skpi ? $skpi->nomor_skpi : '-' }}</div>
                        </div>
                    </div>
